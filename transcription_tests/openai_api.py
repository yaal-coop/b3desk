"""Transcription via OpenAI Whisper + résumé via Albert API."""
# time python transcription_tests/openai_api.py
...
def process(audio_path):
    ...
    transcription_path = next_run_path(transcription_dir, "transcription_openai", "txt")
    summary_path = next_run_path(summary_dir, "summary_openai", "md")
...
for audio_file in [
    AUDIO_DIR / "ETNA_46.mp3",
    AUDIO_DIR / "Reunion_Git_YAAL.mp3",
    AUDIO_DIR / "video_0.mp3",
]:
    process(audio_file)

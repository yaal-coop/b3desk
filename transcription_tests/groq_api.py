"""Transcription via Groq (Whisper) + résumé via Albert API."""
# time python transcription_tests/groq_api.py
...
def process(audio_path):
    ...
    transcription_path = next_run_path(transcription_dir, "transcription_groq", "txt")
    summary_path = next_run_path(summary_dir, "summary_groq", "md")
